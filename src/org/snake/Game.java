...
import org.snake.player.Snake;
import org.snake.utils.FontLoader;
import org.snake.utils.KeyboardListener;
import org.snake.world.World;
...
public class Game {
  ...
  public void run() {
    ...
    final double updateConversion = 0.001D * 10D;
    long secondPoint;
